...
<body>
    ...
    <!-- Lugar onde ficara  as informacoes das ONGS e Imgs-->
    <section id="pfong_cx_info_principal" class="container-fluid">
        <div class="row" id="pfong_caixa_info">
            <div class="col-lg-6 col-md-6 " id="pfong_info">
                <h1 id="pfong_info_titulo">Cia dos Miados e Latidos</h1>
                <p>Nossa ONG nasceu com intenções claras de resgate, castração e doação de animais. Nos empenhamos em abrigar poucos, socorrer vários e castrar MUITOS, pois a castração é a única solução ao problema estrutural da procriação de animais abandonados.</p>
            ...
            <div class="col-lg-6 col-md-6 d-flex justify-content-center align-items-center" id="pfong_caixa_img">
                <div id="pfong_img"></div>
            </div>
        </div>
    </section>

    <!-- Lugar onde encontraremos alguns perfis de animais que estao com a ONG-->
    <section id="pfong_cx_animais" class="container">
        <h1 >Animais com a ONG (98)</h1>
        <div class="row" id="pfong_animais"> 
            <div class="col-lg-4 pfong_cards">
    ...
    <!-- Encontremos aqui, algumas coisas que as Ongs estao precisando-->
    <section class="container-fluid" id="pfong_precisa_cx_principal">
        <h1>Estamos Precisando!</h1>
        <div class="row"  id="pfong_cx_precisa">
