...
<body>
    ...
    <main>
        <form action="" class="card col-lg-9 col-md-6 col-sm-6 col-xs-6 p-5" id="formAnimal" style="width: 50rem">
            ...
            <!-- confirmar com as gurias se deixamos ou não essa opção.
            <div class="form-check form-check-inline">
            ...
            <div class="form-group form-row">
                <!-- pesquisar como colocar em negrito -->
            ...
            <button type="reset" class="btn btn-secondary" id="botaoAnimal">Limpar dados</button>
            <button type="submit" class="btn btn-secondary" id="botaoAnimal">Cadastrar</button>
        </form>
    </main>
    <!-- incluindo o footer -->
