...
@section('content') 
        ...
        <form action="/guardiao/cadastrar" method="POST" enctype="multipart/form-data" class="card col-lg-8 p-5" id="formGuardiao" data-parsley-validate="">
            @csrf
            ...
            <p class="observacao-laranja">*Campos obrigatórios</p>
            ...
            <div class="form-row">
                <div class="form-group col-md-6 p-1">
                    ...
                    <input name="number" value="{{ old("number", '') }}" type="text" class="form-control" id="numero" placeholder="No." required="">
                </div>
                <div class="form-group col-md-6 p-1">
                ...
                <div class="form-group col-md-6 p-1">
                    ...
                    <input name="state" value="{{ old("state", '') }}" type="text" class="form-control" id="uf" placeholder="UF">
