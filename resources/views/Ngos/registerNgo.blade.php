...
<form action="{{ ('cadastro') }}" method="POST" class="card col-lg-8 col-md-12 col-sm-12 col-12 p-5" id="formOng"
...
<form id="demo-form" data-parsley-validate="">
    ...
    <p><small>* Please, note that this demo form is not a perfect example of UX-awareness. The aim here is to show a
