        ...
        <div id="container-form-login" class="col-lg-5 col-md-6 col-sm-6 col-xs-6">
            <form action="#" method="POST">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-6 p-2">
                ...
                <div class="row justify-content-center align-items-baseline">
                    <div class="sobre-senha col-lg-5 col-md-5 col-sm-5 col-xs-5 p-2">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5 col-md-10 col-sm-10 col-xs-5 p-2 m-1 text-center">
