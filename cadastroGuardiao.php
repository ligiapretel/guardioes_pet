    ...
    <main>
        <form action="" class="p-5">
            ...
            <div class="form-group row">
                ...
                <input type="text" class="form-control" id="apelido" placeholder="Como seu nome irá aparecer para outros usuários">
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <input type="password" class="form-control" id="senhaGuardiao" placeholder="Escolha sua senha de no mínimo 6 caracteres">
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <textarea class="form-control" id="textoGuardiao" cols="30" rows="10" placeholder="Descreva por que você quer ser um(a) Guardião(ã)"></textarea>
            </div>
